...
class MedallionFactory():
    ...
    def create_or_get(**kwargs) -> Medallion:
        ...
        try:
            if not isinstance(kwargs["call"], IMedallion.Call):
        ...
        if kwargs["version"] == MedallionFactory.Version.V1:
            if kwargs["call"] == IMedallion.Call.RAW_INTERNAL_DATABASE:
                return Medallion()
