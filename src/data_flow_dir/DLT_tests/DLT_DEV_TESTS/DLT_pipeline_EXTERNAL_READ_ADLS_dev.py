...
def medallion_read_adls_merge_raw_into_bronze_transformation() -> pyspark.sql.dataframe.DataFrame:
    ...
    #run_data_version = "dbfs:/mnt/azure_data_lake/airbnb/test_airbnb_1.csv"
    run_data_version = "dbfs:/mnt/azure_data_lake/airbnb/airbnb_1.csv"
    test_mode = "false"
    ...
    bronze_df = medallion.imedallion_read_adls_merge_raw_into_bronze_transformation(mnt_path=run_data_version, test_mode=test_mode)
...
def medallion_bronze_to_silver_dlt_transformation() -> pyspark.sql.dataframe.DataFrame:
    ...
    silver_df = dlt.read("medallion_read_adls_merge_raw_into_bronze_transformation").dropDuplicates().dropna()
